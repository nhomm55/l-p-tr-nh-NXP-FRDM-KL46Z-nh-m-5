...
void task_test_lcd(void)
{
  ...
  if (!ti_task)
  {
    ...
    switch(count_mode)
    {
    case 0: vfnLCD_Write_Msg("0000");printf("\r\n LCD Test: %d", 0000);  break;
    case 1: vfnLCD_Write_Msg("1111");printf("\r\n LCD Test: %d", 1111);  break;
    case 2: vfnLCD_Write_Msg("2222");printf("\r\n LCD Test: %d", 2222);  break;
    case 3: vfnLCD_Write_Msg("3333");printf("\r\n LCD Test: %d", 3333);  break;
    case 4: vfnLCD_Write_Msg("4444");printf("\r\n LCD Test: %d", 4444);  break;
    case 5: vfnLCD_Write_Msg("5555");printf("\r\n LCD Test: %d", 5555);  break;
    case 6: vfnLCD_Write_Msg("6666");printf("\r\n LCD Test: %d", 6666);  break;
    case 7: vfnLCD_Write_Msg("7777");printf("\r\n LCD Test: %d", 7777);  break;
    case 8: vfnLCD_Write_Msg("8888");printf("\r\n LCD Test: %d", 8888);  break;
    case 9: vfnLCD_Write_Msg("9999");printf("\r\n LCD Test: %d", 9999);  break;
    }
